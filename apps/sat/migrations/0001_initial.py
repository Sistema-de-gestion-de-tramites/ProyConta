# Generated by Django 4.1.3 on 2023-05-25 16:48
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('empleado', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='empleado_id', to='sat.personas', verbose_name='Empleado')),
                ('usuario', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='usuario_id', to=settings.AUTH_USER_MODEL, verbose_name='Usuario')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('persona', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='sat.personas', verbose_name='Persona')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='personas',
            name='tipo_usuario',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='sat.tipo_usuarios', verbose_name='Tipo de usuario'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('direccion', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='sat.direcciones', verbose_name='Dirección')),
            ],
            options={
                'verbose_name': 'Dirección',
                'verbose_name_plural': 'Direcciones',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cliente', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='cliente', to='sat.personas', verbose_name='Cliente')),
                ('empleado', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='empleado', to='sat.personas', verbose_name='Empleado')),
                ('estado', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='sat.estados', verbose_name='Estado')),
                ('tipo_doc', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='sat.tipo_documentos', verbose_name='Tipo de documento')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='persona',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='sat.personas', verbose_name='Persona'),
        ),
        migrations.CreateModel(
            name='Cuentas',
            fields=[
                ...
                ('persona', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='sat.personas', verbose_name='Cliente')),
            ],
            options={
                'verbose_name': 'Cuenta',
